...
bool checkIfItsOne (int kgWatermelon){
    if (kgWatermelon==1){
        return false;
    }else{
        return true;
...
int main(){
    ...
    flag=checkIfItsOne(kgWatermelon);
    moduleOfWatermelon=calculateModule(kgWatermelon);

    if (moduleOfWatermelon == 0 && kgWatermelon<4){
        printf("SI \n");
    }else{
        printf("NO \n");
    }
